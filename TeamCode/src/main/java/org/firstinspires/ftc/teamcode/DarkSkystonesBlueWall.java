...
@Autonomous(name="\uD83D\uDC8E\uD83D\uDD35\uD83C\uDFF0 Skystones Blue Wall", group="workingSkystones")
public class DarkSkystonesBlueWall extends SuperDark implements DarkAutonomous  {
    @Override
    ...
    public void darkRunning() {
        ...
        oldDrive.driveDistance(DeadWheels.grabberSide, distanceSkystone-SKYSTONE_WIDTH, STONE_STRAFE_POWER, STONE_STRAFE_TIME);
