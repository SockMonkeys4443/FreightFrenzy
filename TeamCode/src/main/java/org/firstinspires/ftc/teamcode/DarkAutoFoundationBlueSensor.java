...
public class DarkAutoFoundationBlueSensor extends SuperDark {
    ...
    public void darkRunning() {
        ...
        //drive.driveDistance(DeadWheels.grabberSide, -60.5f, 0.8, 2);
        ...
        drive.driveDistance(DeadWheels.grabberSide, -70, 1, 5);
        drive.driveDistance(DeadWheels.armSide, 15, 0.5, 2);
        stop();
    }
}
