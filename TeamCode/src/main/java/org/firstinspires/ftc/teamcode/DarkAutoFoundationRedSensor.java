...
public class DarkAutoFoundationRedSensor extends SuperDark {
    ...
    public void darkRunning() {
        ...
        drive.stopAll();
        //drive.driveDistance(DeadWheels.grabberSide, -67.5f, 0.3, 10);
        ...
        //15 forwards
        drive.driveDistance(DeadWheels.grabberSide, -10, 1, 2);
        //50 to the right
        drive.driveDistance(DeadWheels.armSide, 25, 1, 3);
        //TODO: put a newTurnTo() here to get back to -180 degrees.
        drive.driveDistance(DeadWheels.armSide, -70, 1, 6);
        drive.driveDistance(DeadWheels.grabberSide, 15, 0.5, 2);
        stop();
